...
class Tickets_model extends CI_Model{
    ...
    public function closed(){
        ...
        while($i < 2){
            ...
            $curl = curl_init();
            curl_setopt($curl, CURLOPT_URL, "http://clockworks.ca/support/helpdesk/api/tickets?count=100&categoryid=3&offset=$offset");
            curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
            curl_setopt($curl, CURLOPT_HTTPHEADER, $headers);
        ...
        while($i < 2){
            ...
            $curl = curl_init();
            curl_setopt($curl, CURLOPT_URL, "http://clockworks.ca/support/helpdesk/api/tickets?count=100&categoryid=14&offset=$offset");
            curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
            curl_setopt($curl, CURLOPT_HTTPHEADER, $headers);
